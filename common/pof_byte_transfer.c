...
{
	//printk(KERN_DEBUG "[POF_DEBUG_INFO:] Unsupport instruction type.\n");
	return POF_ERROR;
}
...
{
	//printk(KERN_DEBUG "[POF_DEBUG_INFO:] Unsupport action type.\n");
	return POF_ERROR;
}
...
#undef ACTION
        default:
            //printk(KERN_DEBUG "[POF_DEBUG_INFO] Unknow action type: %u", p->type);
            break;
    }
    return POF_OK;
}
...
#undef INSTRUCTION
        default:
            //printk(KERN_DEBUG "[POF_DEBUG_INFO:] Unknow Instruction type: %u\n", p->type);
            break;
    }
    return POF_OK;
}
